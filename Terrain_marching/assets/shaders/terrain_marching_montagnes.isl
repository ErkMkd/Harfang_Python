		...
		global %{
			...
			float renvoie_altitude_details(vec2 p)
			{
				float a=texture2D(texture_terrain,p*facteur_echelle_terrain1).r;
					  /*
					  a+=texture2D(texture_terrain,p*facteur_echelle_terrain1+vec2(-2./8192.,0.)).r;
					  a+=texture2D(texture_terrain,p*facteur_echelle_terrain1+vec2(0.,2./8192.)).r;
					  a+=texture2D(texture_terrain,p*facteur_echelle_terrain1+vec2(-2./8192.,0.)).r;
					  a+=texture2D(texture_terrain,p*facteur_echelle_terrain1+vec2(0.,-2./8192.)).r;
					  
					  a+=texture2D(texture_terrain,p*facteur_echelle_terrain1+vec2(-2./8192.,2./8192.)).r;
					  a+=texture2D(texture_terrain,p*facteur_echelle_terrain1+vec2(2./8192.,2./8192.)).r;
					  a+=texture2D(texture_terrain,p*facteur_echelle_terrain1+vec2(2./8192.,-2./8192.)).r;
					  a+=texture2D(texture_terrain,p*facteur_echelle_terrain1+vec2(-2./8192.,-2./8192.)).r;
			   a/=9.;
